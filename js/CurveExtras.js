THREE.Curves = {};
THREE.Curves.GrannyKnot = THREE.Curve.create(function() {}, function(t) {
    t = 2 * Math.PI * t;
    var x = -0.22 * cos(t) - 1.28 * sin(t) - 0.44 * cos(3 * t) - 0.78 *
        sin(3 * t);
    var y = -0.1 * cos(2 * t) - 0.27 * sin(2 * t) + 0.38 * cos(4 * t) +
        0.46 * sin(4 * t);
...
THREE.Curves.HeartCurve = THREE.Curve.create(function(s) {
    ...
    ty = 13 * Math.cos(t) - 5 * Math.cos(2 * t) - 2 * Math.cos(3 * t) -
        Math.cos(4 * t), tz = 0;
...
THREE.Curves.KnotCurve = THREE.Curve.create(function() {}, function(t) {
    t *= 2 * Math.PI;
    var R = 10;
    var s = 50;
    var tx = s * Math.sin(t),
...
THREE.Curves.HelixCurve = THREE.Curve.create(function() {}, function(t) {
    var a = 30;
    var b = 150;
